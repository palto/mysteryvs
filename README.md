...
- Composio (for the AI assistant's Google Sheets integration). Set in `.env`:
  ...
  - `COMPOSIO_GOOGLE_SHEETS_AUTH_CONFIG_ID` — the `ac_...` auth config id for the
    Google Sheets OAuth integration, created in the [Composio dashboard](https://dashboard.composio.dev/)
